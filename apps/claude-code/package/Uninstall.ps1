...
# Remove the detection marker first - see ARCHITECTURE.md "Detection via marker files".
# Non-fatal: if marker removal fails, detection may keep reporting "installed"
# until the next install/uninstall, but it does not block the rest of uninstall.
