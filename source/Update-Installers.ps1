...
.DESCRIPTION
    Companion to source\Update-Tooling.ps1. Where Update-Tooling.ps1
    ...
    The "pivot from winget" rationale lives in ARCHITECTURE.md. tl;dr:
    winget is unsupported in SYSTEM context per Microsoft docs and fails
    on fresh Autopilot devices, so the three system-context apps now
    bundle their installers directly.
